...
export class SatoriProvider implements ScreenshotProvider {
    ...
    private renderBanner(data: ScreenshotData, colorTheme: string = 'default'): any {
        const themes: Record<string, { 
            ...
            default: {
                bg: '#ffffff',
                cardBg: 'linear-gradient(135deg, #ffffff 0%, #faf5ff 50%, #fdf2f8 100%)',
                titleColor: '#1f2937',
                textColor: '#6b7280',
            ...
            gradient: {
                bg: '#ffffff',
                cardBg: 'linear-gradient(135deg, #a855f7 0%, #ec4899 50%, #f97316 100%)',
                titleColor: '#ffffff',
                textColor: 'rgba(255,255,255,0.9)',
                subtitleColor: 'rgba(255,255,255,0.7)',
                footerColor: '#9ca3af',
                channelBg: (color: string) => `${color}30`,
                channelText: 'rgba(255,255,255,0.9)',
                cardShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)',
                qrRing: '1px solid rgba(255,255,255,0.2)',
            },
            dark: {
                bg: '#ffffff',
                cardBg: '#111827',
                                                ...
                                                children: [
                                                    ...
                                                    },
                                                    {
                                                        ...
                                                        props: {
                                                            ...
                                                            children: data.tip || '请打开支持的付款软件并扫一扫',
                                                        },
                                                    },
                                                ],
                                            },
