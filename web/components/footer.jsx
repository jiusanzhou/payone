...
const Footer = ({ powered = false, transparent = false }) => {
  ...
  return <footer className={baseClass}>    
    {powered?<p className="flex items-center justify-center">Powered by
      <Link href="/" className={linkClass}>PayOne</Link>
    </p>
    :<p className="flex items-center justify-center">Made with
      <span role="img" aria-label="love" className="text-xs mx-1">❤️</span>
      by
      <Link href="https://zoe.im" className={linkClass}>Zoe</Link>
    </p>}
  </footer>
}
